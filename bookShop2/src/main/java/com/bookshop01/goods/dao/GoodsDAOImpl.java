...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	@Override
	public List<GoodsVO> selectsort(String goods_sort ) throws DataAccessException {
		List<GoodsVO> goodsList=(ArrayList)sqlSession.selectList("mapper.goods.selectsort",goods_sort);
	   return goodsList;	
