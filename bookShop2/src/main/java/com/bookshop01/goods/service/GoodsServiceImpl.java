...
public class GoodsServiceImpl implements GoodsService{
	...
	public Map<String,List<GoodsVO>> listGoods() throws Exception {
		...
		goodsList=goodsDAO.selectGoodsList("buy_out");
		goodsMap.put("buy_out",goodsList);
		return goodsMap;
	}
	@Override
	public Map<String, List<GoodsVO>> goodsList(String goods_sort) throws Exception {
		Map<String,List<GoodsVO>> goodsMap=new HashMap<String,List<GoodsVO>>();
		List<GoodsVO> goodsList=goodsDAO.selectsort("제주 카페");
		goodsMap.put("sort",goodsList);
		return goodsMap;
	}
		@Override
	public Map<String, List<GoodsVO>> goodsList1(String goods_sort) throws Exception {
		Map<String,List<GoodsVO>> goodsMap=new HashMap<String,List<GoodsVO>>();
		List<GoodsVO> goodsList=goodsDAO.selectsort("제주 숙소");
		goodsMap.put("sort1",goodsList);
		return goodsMap;
	}
		@Override
		public Map<String, List<GoodsVO>> goodsList2(String goods_sort) throws Exception {
			Map<String,List<GoodsVO>> goodsMap=new HashMap<String,List<GoodsVO>>();
			List<GoodsVO> goodsList=goodsDAO.selectsort("올레길");
			goodsMap.put("sort2",goodsList);
			return goodsMap;
		}
