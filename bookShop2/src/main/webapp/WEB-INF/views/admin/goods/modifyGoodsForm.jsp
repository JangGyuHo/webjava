		...
		<DIV class="tab_container">
			...
			<tr>
				...
				<td width=500>
				  <select name="goods_sort">
					<c:choose>
				      <c:when test="${goods.goods_sort=='제주 숙소' }">
						<option value="제주 숙소" selected>제주 숙소 </option>
				  	    <option value="제주 카페">제주 카페 </option>
				  	   <option value="올레길">올레길</option>
				  	  </c:when>
				  	  <c:when test="${goods.goods_sort=='제주 카페' }">
						<option value="제주 숙소" >제주 숙소 </option>
				  	    <option value="제주 카페" selected>제주 카페 </option>
				  	    <option value="올레길">올레길</option>
				  	   </c:when>
				  	  <c:when test="${goods.goods_sort=='올레길' }">
						<option value="제주 숙소" >제주 숙소 </option>
				  	    <option value="제주 카페" >제주 카페 </option>
				  	    <option value="올레길" selected>올레길</option>
				  	  </c:when>
				  	</c:choose>
					</select>
				</td>
			...
			<tr>
				...
				<option value="newbook" selected >제주 숙소</option>
				  ...
				  <option value="out_of_print" >매진</option>
				</select>
