...
<body >
	<H3>업체 조회</H3>
	<form  method="post">	
		<TABLE cellpadding="10" cellspacing="10"  id="tb">
			<TBODY>
				<tr>
					<td>
				...
				<tr>
				  <td>
				    <select name="search_condition" disabled >
						...
						<option value="영화번호">업체번호</option>
						<option value="영화제목">업체명</option>
						<option value="배급사">주소</option>
					</select>
   ...
   <c:choose>
     ...
     <c:forEach var="item" items="${newGoodsList }">
			 <TR style="background:#ffffff">       
				...
				<TD >
				 <a href="${pageContext.request.contextPath}/admin/goods/modifyGoodsForm.do?goods_id=${item.goods_id}" id="ti">
				...
				<TD >
				 <a href="${pageContext.request.contextPath}/admin/goods/removeGoods.do?goods_id=${item.goods_id}" id="ti">
				    <strong>삭제 </strong>
				 </a> 
				</TD>
			</TR>
...
<DIV id="search">
	<form action="${contextPath}/admin/goods/addNewGoodsForm.do">
		<input   type="submit" value="업체 등록하기">
</form>
</DIV>
</body>
</html>