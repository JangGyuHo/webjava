		...
		<table  id="tb">
			<tbody>
				<tr class="dot_line">
					...
					<td>
					    <input type="radio" id="delivery_method" name="delivery_method" value="일반택배" checked>계좌이체 &nbsp;&nbsp;&nbsp; 
						<input type="radio" id="delivery_method" name="delivery_method" value="편의점택배">신용카드 &nbsp;&nbsp;&nbsp; 
						<input type="radio" id="delivery_method" name="delivery_method" value="해외배송">휴태폰 &nbsp;&nbsp;&nbsp;
				    </td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">영화관 선택</td>
					<td><input type="radio" name="delivery_place"
						onClick="restore_all()" value="기본배송지" checked>최근본 지점 &nbsp;&nbsp;&nbsp; 
						<input type="radio" name="delivery_place" value="새로입력" onClick="reset_all()">다른 지점 선택 &nbsp;&nbsp;&nbsp;
			...
			<table>
				...
				<!--  	<tr>
				   ...
				   <tr>
					 ...
					 <td>
						  <p id="p_order_goods_title"> 결제 영화제목 </p>    
					 </td>
				   </tr>
				   <tr>
					  <td width=200px>
					 ...
					 <td>
						  <p id="p_total_order_goods_qty"> 결제티켓수 </p>    
					 </td>
				   </tr>
				   <tr>
					  <td width=200px>
					 ...
					 <td >
					      <p id="p_total_order_goods_price">결제금액합계</p>
					 </td>
				   </tr>
					<tr>
					  <td width=200px>
...
<tr align="center">
    <div class="container" >
        <div class="screen"><h2><p align="center">screen</p></h2></div>
