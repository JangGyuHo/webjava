		...
		<table id="tb">
			<tbody>
				...
				<tr class="dot_line">
					...
					<input type="checkbox"	name="smssts_yn" value="Y" checked /> 본 사이트에서 발송하는 SMS 소식을 수신합니다.</td>
				</tr>
				<tr class="dot_line">
					...
					<td><input size="10px"   type="text" name="email1" /> @ <input  size="10px"  type="text"name="email2" /> 
						  <select name="email2" onChange=""	title="직접입력">
							...
							</select><br> <br> <input type="checkbox" name="emailsts_yn" value="Y" checked /> 본 사이트에서 발송하는 e-mail을 수신합니다.</td>
				</tr>
				<tr class="dot_line">
